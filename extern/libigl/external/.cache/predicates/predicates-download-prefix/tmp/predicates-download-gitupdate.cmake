...
execute_process(
  COMMAND "/usr/local/bin/git" show-ref 5a1d2194ec114bff51d5a33230586cafb83adc86
  WORKING_DIRECTORY "/Users/guodewen/libigl/cmake/../external/predicates"
...
# yet).
execute_process(
  COMMAND "/usr/local/bin/git" rev-list --max-count=1 5a1d2194ec114bff51d5a33230586cafb83adc86
  WORKING_DIRECTORY "/Users/guodewen/libigl/cmake/../external/predicates"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/guodewen/libigl/cmake/../external/predicates/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/guodewen/libigl/cmake/../external/predicates/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
    execute_process(
      COMMAND "/usr/local/bin/git" checkout 5a1d2194ec114bff51d5a33230586cafb83adc86
      WORKING_DIRECTORY "/Users/guodewen/libigl/cmake/../external/predicates"
      RESULT_VARIABLE error_code
      )
    if(error_code)
