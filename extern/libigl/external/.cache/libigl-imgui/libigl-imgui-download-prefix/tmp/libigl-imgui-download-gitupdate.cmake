...
execute_process(
  COMMAND "/usr/local/bin/git" show-ref 07ecd3858acc71e70f0f9b2dea20a139bdddf8ae
  WORKING_DIRECTORY "/Users/guodewen/Desktop/fem/extern/libigl/cmake/../external/libigl-imgui"
...
# yet).
execute_process(
  COMMAND "/usr/local/bin/git" rev-list --max-count=1 07ecd3858acc71e70f0f9b2dea20a139bdddf8ae
  WORKING_DIRECTORY "/Users/guodewen/Desktop/fem/extern/libigl/cmake/../external/libigl-imgui"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/guodewen/Desktop/fem/extern/libigl/cmake/../external/libigl-imgui/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/guodewen/Desktop/fem/extern/libigl/cmake/../external/libigl-imgui/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
    execute_process(
      COMMAND "/usr/local/bin/git" checkout 07ecd3858acc71e70f0f9b2dea20a139bdddf8ae
      WORKING_DIRECTORY "/Users/guodewen/Desktop/fem/extern/libigl/cmake/../external/libigl-imgui"
      RESULT_VARIABLE error_code
      )
    if(error_code)
