...
execute_process(
  COMMAND "/usr/local/bin/git" show-ref b5dddf45e329af685cd107e38770a28cfc18eb15
  WORKING_DIRECTORY "/Users/guodewen/libigl/cmake/../external/../tests/data"
...
# yet).
execute_process(
  COMMAND "/usr/local/bin/git" rev-list --max-count=1 b5dddf45e329af685cd107e38770a28cfc18eb15
  WORKING_DIRECTORY "/Users/guodewen/libigl/cmake/../external/../tests/data"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/guodewen/libigl/cmake/../external/../tests/data/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/guodewen/libigl/cmake/../external/../tests/data/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
    execute_process(
      COMMAND "/usr/local/bin/git" checkout b5dddf45e329af685cd107e38770a28cfc18eb15
      WORKING_DIRECTORY "/Users/guodewen/libigl/cmake/../external/../tests/data"
      RESULT_VARIABLE error_code
      )
    if(error_code)
