...
execute_process(
  COMMAND "/usr/local/bin/git" show-ref d175e9de0be0d4db75d0a8cf065599a435a87eb6
  WORKING_DIRECTORY "/Users/guodewen/libigl/cmake/../external/tinyxml2"
...
# yet).
execute_process(
  COMMAND "/usr/local/bin/git" rev-list --max-count=1 d175e9de0be0d4db75d0a8cf065599a435a87eb6
  WORKING_DIRECTORY "/Users/guodewen/libigl/cmake/../external/tinyxml2"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/guodewen/libigl/cmake/../external/tinyxml2/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/guodewen/libigl/cmake/../external/tinyxml2/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
    execute_process(
      COMMAND "/usr/local/bin/git" checkout d175e9de0be0d4db75d0a8cf065599a435a87eb6
      WORKING_DIRECTORY "/Users/guodewen/libigl/cmake/../external/tinyxml2"
      RESULT_VARIABLE error_code
      )
    if(error_code)
