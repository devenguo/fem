...
execute_process(
  COMMAND "/usr/local/bin/git" show-ref c63e7a6434652b8a2065c835bd9d6d298db1a0bc
  WORKING_DIRECTORY "/Users/guodewen/libigl/cmake/../external/tetgen"
...
# yet).
execute_process(
  COMMAND "/usr/local/bin/git" rev-list --max-count=1 c63e7a6434652b8a2065c835bd9d6d298db1a0bc
  WORKING_DIRECTORY "/Users/guodewen/libigl/cmake/../external/tetgen"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/guodewen/libigl/cmake/../external/tetgen/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/guodewen/libigl/cmake/../external/tetgen/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
    execute_process(
      COMMAND "/usr/local/bin/git" checkout c63e7a6434652b8a2065c835bd9d6d298db1a0bc
      WORKING_DIRECTORY "/Users/guodewen/libigl/cmake/../external/tetgen"
      RESULT_VARIABLE error_code
      )
    if(error_code)
