...
execute_process(
  COMMAND "/usr/local/bin/git" show-ref 2d0507db43cd5a117f7843e053b17dffca114107
  WORKING_DIRECTORY "/Users/guodewen/Desktop/libigl/cmake/../external/pybind11"
...
# yet).
execute_process(
  COMMAND "/usr/local/bin/git" rev-list --max-count=1 2d0507db43cd5a117f7843e053b17dffca114107
  WORKING_DIRECTORY "/Users/guodewen/Desktop/libigl/cmake/../external/pybind11"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/guodewen/Desktop/libigl/cmake/../external/pybind11/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/guodewen/Desktop/libigl/cmake/../external/pybind11/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
    execute_process(
      COMMAND "/usr/local/bin/git" checkout 2d0507db43cd5a117f7843e053b17dffca114107
      WORKING_DIRECTORY "/Users/guodewen/Desktop/libigl/cmake/../external/pybind11"
      RESULT_VARIABLE error_code
      )
    if(error_code)
